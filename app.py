...
st.set_page_config(
    page_title="AI HYBRID RAG Chatbot",
    page_icon="🤖",
    layout="wide",
...
def main():
    ...
    if prompt := st.chat_input("Ask a question about your documents..."):
        ...
        with st.chat_message("assistant"):
            try:
                # Step 1: Get sources BEFORE streaming
                # This avoids running the query twice
                ...
                # Step 3: Sources are now available after get_response()
                sources = chat.get_last_sources()

                # Step 4: Show sources if available
                if sources:
