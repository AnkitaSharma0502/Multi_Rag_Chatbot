...
Role of class - This class has ONE job: orchestrate retrieval and generation
...
class RAGChain:
    ...
    # Format retrieved documents into a context string with proper citations
    ...
    # 
        ...
        # Citation format: [Doc] myfile.pdf – Chunk3
